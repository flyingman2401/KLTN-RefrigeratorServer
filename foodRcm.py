...
def RecommendDishes(now, userID):
    ...
    ratingList = databaseAccess.listCollectionItem(collectionList['Rating'], {"user_id": userID})
    ingredientIFList = databaseAccess.listCollectionItem(collectionList['IngredientInsideFridge'], {"user_id": userID})
